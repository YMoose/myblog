# 软件架构
> 本文部分术语来自于Martin Fowler的《企业应用架构模式》
学习软件软件架构是在学什么？是在学习对抗系统复杂性的实践经验
...
## 1. 训练架构能力
### 1.1. 从优秀的开源项目中学习
首先了解开源项目要解决的问题，其次了解开源项目的模块划分（学习子模块时也同样可以使用此方法分析）
再从三个维度去分析开源项目的架构实践，可以从上至下（topdown）也可以自底向上
1. 如何将系统的复杂度封装
2. 如何将系统的功能进行抽象，系统经过抽象后对外暴露的接口
3. 系统与系统之间的交互（包括同级系统、上下级系统）

## 2. 一些架构经验
### 2.1. 企业架构（框架） Enterprise Architecture
...
我的理解三个基本层和冯·诺依曼结构类似。表现层是I/O，领域层是运算器和控制器，数据源层是存储单元。
#### 2.1.1. 表现层
