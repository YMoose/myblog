...
```
2. 每个load操作获取的值来自其 **<m** 序列中向前最近一次的store结果
3. ![](../pic/Relaxed_memory_consistency_exampleC.png)
...
8. [A Primer On Memory Consistency And Cache Coherence（内存一致性文章原文）](./APrimerOnMemoryConsistencyAndCacheCoherence.pdf)
